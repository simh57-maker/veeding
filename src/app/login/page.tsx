    ...
    <div className="min-h-screen flex items-center justify-center bg-[#1E1E1E]">
      <div className="bg-[#2C2C2C] border border-[#333] rounded-2xl p-10 w-full max-w-sm flex flex-col items-center gap-6 shadow-2xl">
        <div className="flex items-center gap-3">
          <div className="bg-[#0D99FF] rounded-xl p-2">
            <Video className="w-6 h-6 text-white" />
          </div>
          <span className="text-2xl font-bold text-white tracking-tight">Veeding</span>
        </div>

        <div className="text-center">
          <p className="text-[#888] text-sm">AI Video Seeding Editor</p>
          <p className="text-[#E0E0E0] text-base mt-1">Sign in to continue</p>
        </div>
